package org.mistex.game.world.content.prayers;
...
public class QuickPrayers {
	...
	private static final int[] prayerReq = { 1, 4, 7, 8, 9, 10, 13, 16, 19, 22, 25, 26, 27, 28, 31, 34, 37, 40, 43, 44, 45, 46, 49, 52, 70, 75 };
	...
	public static void clickPray(Client  c, int actionId) {
		...
		for (int j = 0; j < data.length; j++) {
			if (data[j][0] == actionId) {
				if (c.quickPrayers[data[j][2]] || c.getPA().getLevelForXP(c.playerXP[Player.playerPrayer]) < prayerReq[j]) {
