...
public class CraftingData extends Skill {
	...
	public static enum leatherDialogueData {
		...
		GREEN_LEATHER(1745, 1065, 1099, 1135), BLUE_LEATHER(2505, 2487, 2493,
				2499), RED_LEATHER(2507, 2489, 2495, 2501), BLACK_LEATHER(2509,
				2491, 2497, 2503);
	...
	public static enum leatherData {
		...
		LEATHER_BODY(new int[][] { { 33187, 1 }, { 33186, 5 }, { 33185, 10 } },
				...
				new int[][] { { 33196, 1 }, { 33195, 1 }, { 33194, 1 } }, 1741,
				...
				{ 10238, 10 }, { 6212, 28 } }, 1743, 1131, 28, 35, 1), SNAKESKIN_BODY(
				...
				new int[][] { { 35005, 1 }, { 35004, 5 }, { 35003, 10 },
						{ 35002, 28 } }, 6289, 6330, 47, 35, 8),

		GREEN_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 },
				{ 34183, 10 }, { 34182, 28 } }, 1745, 1065, 57, 124, 1), GREEN_DHIDE_BODY(
				new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 },
						{ 34186, 28 } }, 1745, 1099, 60, 186, 2), GREEN_DHIDE_CHAPS(
				new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 },
						{ 34190, 28 } }, 1745, 1135, 63, 62, 3),

		BLUE_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 },
				{ 34183, 10 }, { 34182, 28 } }, 2505, 2487, 66, 70, 1), BLUE_DHIDE_BODY(
				new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 },
						{ 34186, 28 } }, 2505, 2493, 68, 140, 2), BLUE_DHIDE_CHAPS(
				new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 },
						{ 34190, 28 } }, 2505, 2499, 71, 210, 3),

		RED_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 },
				{ 34183, 10 }, { 34182, 28 } }, 2507, 2489, 73, 78, 1), RED_DHIDE_BODY(
				new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 },
						{ 34186, 28 } }, 2507, 2495, 75, 156, 2), RED_DHIDE_CHAPS(
				new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 },
						{ 34190, 28 } }, 2507, 2501, 77, 234, 3),

		BLACK_DHIDE_VAMBRACES(new int[][] { { 34185, 1 }, { 34184, 5 },
				{ 34183, 10 }, { 34182, 28 } }, 2509, 2491, 79, 86, 1), BLACK_DHIDE_BODY(
				new int[][] { { 34193, 1 }, { 34192, 5 }, { 34191, 10 },
						{ 34190, 28 } }, 2509, 2503, 84, 258, 3), BLACK_DHIDE_CHAPS(
				new int[][] { { 34189, 1 }, { 34188, 5 }, { 34187, 10 },
						{ 34186, 28 } }, 2509, 2497, 82, 172, 2);
