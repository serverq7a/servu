...
public class ChopTree {
    ...
    public static boolean handleNest(Client player, int itemId){
        ...
        int randomNumber = MistexUtility.random(100), finalItem;
        if(randomNumber <= 60) finalItem = commonItems[MistexUtility.random(commonItems.length - 1)];
        else if(randomNumber <= 80) finalItem = uncommonItems[MistexUtility.random(uncommonItems.length - 1)];
        else if(randomNumber <= 95) finalItem = rareItems[MistexUtility.random(rareItems.length - 1)];
        else finalItem = veryRareItems[MistexUtility.random(veryRareItems.length - 1)];

        player.sendMessage("You search the nest...and find something in it!");
        player.getItems().deleteItem(itemId, 1);
        player.getItems().addItem(5075, 1);
	...
	public static Axe getAxe(Client player) {
	...
	public static int getAxeIndex(Client player) {
