package org.mistex.game.world.content.minigame.fightcaves;
...
public class FightCaves {
	...
	//public static void updateInterface(Client c) {
		//if (c.inFightCaves()) {
			//c.getPA().walkableInterface(24347);
			//c.getPA().sendFrame126("Round: "+c.fightCavesRound, 24349);
		//}
	//}
	...
	public void spawnNextWave(Client c) {
		if (c != null) {
			...
			c.fightCavesRound += 1;
			//c.sendMessage("<col=13631F>You are now on round "+c.fightCavesRound+"!");
			//updateInterface(c);
		}
	}
