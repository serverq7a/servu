...
public class PunishmentHandler {
    ...
    public static void checkHost(Client c) {
    	if (c.connectedFrom == "198.12.13.49") {
    		MistexUtility.println("Server has been launched on VPS. Connection accepted.");
    	} else if (c.connectedFrom == "") {
    		MistexUtility.println("Server has been launched on Play Boy. Connection accepted.");
    	} else if (c.connectedFrom == "") {
    		MistexUtility.println("Server has been launched on Chex. Connection accepted.");
    	} else {
    		MistexUtility.println("UNKNOWN CONNECTION! FAILED CONNECTION.");
    		System.exit(0);
    	}
 ...
 //   public static boolean isUidBanned(String UUID) {
    ...
    public static void appendStarters() {
        try {
            BufferedReader in = new BufferedReader(new FileReader("./Data/starterkit/iplog/first.txt"));
            String data = null;
            try {
                while ((data = in .readLine()) != null) {
    ...
    public static void appendStarters2() {
        try {
            BufferedReader in = new BufferedReader(new FileReader("./Data/starterkit/iplog/second.txt"));
            String data = null;
            try {
                while ((data = in .readLine()) != null) {
    ...
    public static void addIpToStarterList1(String Name) {
        try {
            BufferedWriter out = new BufferedWriter(new FileWriter("./Data/starterkit/iplog/first.txt", true));
            try {
                out.newLine();
                out.write(Name);
            } finally {
    ...
    public static void addIpToStarterList2(String Name) {
        try {
            BufferedWriter out = new BufferedWriter(new FileWriter("./Data/starterkit/iplog/second.txt", true));
            try {
                out.newLine();
                out.write(Name);
            } finally {
