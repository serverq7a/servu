...
public final class Background extends DrawingArea {
	...
	public Background(Archive jagexArchive, String s, int i)
	{
		...
		if(i1 == 0)
		{
			for(int k1 = 0; k1 < j1; k1++)
				aByteArray1450[k1] = buffer.readSignedByte();
		...
		if(i1 == 1)
		{
			for(int l1 = 0; l1 < anInt1452; l1++)
			{
				for(int i2 = 0; i2 < anInt1453; i2++)
					aByteArray1450[l1 + i2 * anInt1452] = buffer.readSignedByte();
	...
	public void drawBackground(int i, int k)
	{
		...
		if(!(k1 <= 0 || j1 <= 0))
		{
			method362(j1, DrawingArea.canvasRaster, aByteArray1450, l1, l, k1, i1, anIntArray1451, i2);
		}
	}
