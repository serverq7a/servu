...
public class SpriteLoader {
	...
	public static void loadSprites(Archive archive) {
		try {
			Buffer index = new Buffer(Utility.readFile(Signlink.findcachedir() + "Interfaces/sprites.idx"));
			Buffer data = new Buffer(Utility.readFile(Signlink.findcachedir() + "Interfaces/sprites.dat"));
	...
	public static void createSprite(SpriteLoader sprite) {
		if (dumping) {
			File directory = new File(Signlink.findcachedir() + "Interfaces/dump/");
			if (!directory.exists()) {
				directory.mkdir();
			}
