...
public class RSFont extends DrawingArea {
        ...
        for (int currentCharacter = 0; currentCharacter < string.length(); currentCharacter++) {
            ...
            if (character == 60) {
                ...
                if (startIndex == -1) {
                    ...
                    if (underlineColor != -1) {
                    	DrawingArea.drawHorizontalLine(drawX, drawY + baseCharacterHeight, i_109_,
                                                         underlineColor);
                    }
                    drawX += i_109_;
                }
    ...
    public static String handleOldSyntax(String text) {
    	text = text.replaceAll("@raw@", "<col=FF0000>");
    	text = text.replaceAll("@dev@", "<col=BB2AF5>");
    	text = text.replaceAll("@ceo@", "<col=1F9100>");
    	text = text.replaceAll("@war@", "<col=F752CB>");
    ...
    public void drawTransparentCharacter(int i, int i_11_, int i_12_, int i_13_, int i_14_,
        ...
        int i_17_ = i_11_ + i_12_ * DrawingArea.canvasWidth;
        int i_18_ = DrawingArea.canvasWidth - i_13_;
        int i_19_ = 0;
        int i_20_ = 0;
        if (i_12_ < DrawingArea.clipStartY) {
            int i_21_ = DrawingArea.clipStartY - i_12_;
            i_14_ -= i_21_;
            i_12_ = DrawingArea.clipStartY;
            i_20_ += i_21_ * i_13_;
            i_17_ += i_21_ * DrawingArea.canvasWidth;
        }
        if (i_12_ + i_14_ > DrawingArea.clipEndY) {
            i_14_ -= i_12_ + i_14_ - DrawingArea.clipEndY;
        }
        if (i_11_ < DrawingArea.clipStartX) {
            int i_22_ = DrawingArea.clipStartX - i_11_;
            i_13_ -= i_22_;
            i_11_ = DrawingArea.clipStartX;
            i_20_ += i_22_;
            i_17_ += i_22_;
            i_19_ += i_22_;
            i_18_ += i_22_;
        }
        if (i_11_ + i_13_ > DrawingArea.clipEndX) {
            int i_23_ = i_11_ + i_13_ - DrawingArea.clipEndX;
            i_13_ -= i_23_;
            i_19_ += i_23_;
            i_18_ += i_23_;
        }
        if (i_13_ > 0 && i_14_ > 0) {
            createTransparentCharacterPixels(DrawingArea.canvasRaster, fontPixels[i], i_15_,
    ...
    public void drawCharacter(int character, int i_35_, int i_36_, int i_37_, int i_38_,
        ...
        int i_40_ = i_35_ + i_36_ * DrawingArea.canvasWidth;
        int i_41_ = DrawingArea.canvasWidth - i_37_;
        int i_42_ = 0;
        int i_43_ = 0;
        if (i_36_ < DrawingArea.clipStartY) {
            int i_44_ = DrawingArea.clipStartY - i_36_;
            i_38_ -= i_44_;
            i_36_ = DrawingArea.clipStartY;
            i_43_ += i_44_ * i_37_;
            i_40_ += i_44_ * DrawingArea.canvasWidth;
        }
        if (i_36_ + i_38_ > DrawingArea.clipEndY) {
            i_38_ -= i_36_ + i_38_ - DrawingArea.clipEndY;
        }
        if (i_35_ < DrawingArea.clipStartX) {
            int i_45_ = DrawingArea.clipStartX - i_35_;
            i_37_ -= i_45_;
            i_35_ = DrawingArea.clipStartX;
            i_43_ += i_45_;
            i_40_ += i_45_;
            i_42_ += i_45_;
            i_41_ += i_45_;
        }
        if (i_35_ + i_37_ > DrawingArea.clipEndX) {
            int i_46_ = i_35_ + i_37_ - DrawingArea.clipEndX;
            i_37_ -= i_46_;
            i_42_ += i_46_;
            i_41_ += i_46_;
        }
        if (i_37_ > 0 && i_38_ > 0) {
        	try {
            createCharacterPixels(DrawingArea.canvasRaster, fontPixels[character],
