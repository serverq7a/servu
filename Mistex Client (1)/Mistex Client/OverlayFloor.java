...
public class OverlayFloor {
    ...
    public static OverlayFloor[] overLayFlo474s;
    ...
    public static void unpackConfig(Archive streamLoader) {
        ...
        overLayFlo474s = new OverlayFloor[count];
        for (int i = 0; i < count ; i++) {
            if (overLayFlo474s[i] == null)
                overLayFlo474s[i] = new OverlayFloor();
            overLayFlo474s[i].parse(buffer);
        }
