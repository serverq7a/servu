...
public final class Signlink implements Runnable {
	...
	public static String findcachedir() {
		File file = new File(System.getProperty("user.home") + "/MistexCache/");
		if (!file.exists()) {
			if (!file.mkdir())
				return secondDir();
		}
		return System.getProperty("user.home") + "/MistexCache/";
		//return "./MistexCachev1/";
    }
	
	public static String secondDir() {
		File file = new File("c:/MistexCache/");
		if (!file.exists())
			file.mkdir();
