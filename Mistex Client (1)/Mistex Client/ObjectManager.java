		...
		for (int l6 = -5; l6 < anInt146 + 5; l6++) {
			for (int i8 = 0; i8 < anInt147; i8++) {
				...
				if (k9 >= 0 && k9 < anInt146) {
					...
					if (l12 > 0) {
						UnderlayFloor flo = UnderlayFloor.cache[l12 - 1];
				...
				if (i13 >= 0 && i13 < anInt146) {
					...
					if (i14 > 0) {
						UnderlayFloor flo_1 = UnderlayFloor.cache[i14 - 1];
			...
			if (l6 >= 1 && l6 < anInt146 - 1) {
				...
				for (int k17 = -5; k17 < anInt147 + 5; k17++) {
					...
					if (k17 >= 1
							&& k17 < anInt147 - 1 && (GameConfiguration.VISIBLE_LEVELS || (aByteArrayArrayArray149[0][l6][k17] & 2) != 0 || (aByteArrayArrayArray149[l][l6][k17] & 0x10) == 0
						...
						if (l18 > 0 || i19 > 0) {
							...
							if (l > 0) {
								...
								if (l18 == 0
									...
									flag = false;
								if (i19 > 0
										&& !OverlayFloor.overLayFlo474s[i19 - 1].aBoolean393)
									flag = false;
							...
							if (i19 == 0) {
								...
								OverlayFloor overlay_flo = OverlayFloor.overLayFlo474s[i19 - 1];
								...
								if (textureId >= 0) {
                                    k23 = Rasterizer.getTextureColour(textureId);
                                    j23 = -1;
                                    ...
                                    k23 = Rasterizer.hsl2rgb[method185(overlay_flo.anInt399, 96)];                                
                                    j23 = -2;
                                    textureId = -1;
                                } else {
								...
								if((i19-1) == 111){
									k23 = Rasterizer.getTextureColour(1);
...
label0:
	...
	private void method175(int i, Scene worldController, CollisionMap class11, int j, int k, int l, int i1, int j1)
	{
		if(!GameConfiguration.VISIBLE_LEVELS && (aByteArrayArrayArray149[0][l][i] & 2) == 0)
			{
			...
			if(j == 22)
			{
				if(!GameConfiguration.GROUND_DECORATION && !class46.hasActions && !class46.aBoolean736)
					return;
				Object obj;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj = class46.method578(22, j1, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 10 || j == 11)
			{
				Object obj1;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj1 = class46.method578(10, j1, k1, l1, i2, j2, -1, -1, -1, -1);
				else
				...
				if(obj1 != null)
				{
					...
					if(worldController.method284(l2, byte0, k2, l4, ((Animable) (obj1)), j4, k, i5, i, l) && class46.aBoolean779)
					{
						...
						if(obj1 instanceof Model)
							...
							model = class46.method578(10, j1, k1, l1, i2, j2, -1, -1, -1, -1);
						if(model != null)
						{
			...
			if(j >= 12)
			{
				Object obj2;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj2 = class46.method578(j, j1, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 0)
			{
				Object obj3;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj3 = class46.method578(0, j1, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 1)
			{
				Object obj4;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj4 = class46.method578(1, j1, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 2)
			{
				...
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
				{
					obj11 = class46.method578(2, 4 + j1, k1, l1, i2, j2, -1, -1, -1, -1);
					obj12 = class46.method578(2, i3, k1, l1, i2, j2, -1, -1, -1, -1);
				} else
				{
			...
			if(j == 3)
			{
				Object obj5;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj5 = class46.method578(3, j1, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 9)
			{
				Object obj6;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj6 = class46.method578(j, j1, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 4)
			{
				Object obj7;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj7 = class46.method578(4, 0, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 5)
			{
				...
				Object obj13;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj13 = class46.method578(4, 0, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 6)
			{
				Object obj8;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj8 = class46.method578(4, 0, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 7)
			{
				Object obj9;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj9 = class46.method578(4, 0, k1, l1, i2, j2, -1, -1, -1, -1);
				else
			...
			if(j == 8)
			{
				Object obj10;
				if(class46.anInt781 == -1 && class46.childrenIDs == null)
					obj10 = class46.method578(4, 0, k1, l1, i2, j2, -1, -1, -1, -1);
				else
	...
	public final void method183(CollisionMap aclass11[], Scene worldController, int i, int j, int k, int l,
...
label0:
	...
	public static void method188(Scene worldController, int i, int j, int k, int l, CollisionMap class11, int ai[][][], int i1,
								 int j1, int k1)
	{
		int l1 = ai[l][i1][j];
		int i2 = ai[l][i1 + 1][j];
		...
		if(k == 22)
		{
			Object obj;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj = class46.method578(22, i, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 10 || k == 11)
		{
			Object obj1;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj1 = class46.method578(10, i, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k >= 12)
		{
			Object obj2;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj2 = class46.method578(k, i, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 0)
		{
			Object obj3;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj3 = class46.method578(0, i, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 1)
		{
			Object obj4;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj4 = class46.method578(1, i, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 2)
		{
			...
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
			{
				obj11 = class46.method578(2, 4 + i, l1, i2, j2, k2, -1, -1, -1, -1);
				obj12 = class46.method578(2, j3, l1, i2, j2, k2, -1, -1, -1, -1);
			} else
			{
		...
		if(k == 3)
		{
			Object obj5;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj5 = class46.method578(3, i, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 9)
		{
			Object obj6;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj6 = class46.method578(k, i, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 4)
		{
			Object obj7;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj7 = class46.method578(4, 0, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 5)
		{
			...
			Object obj13;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj13 = class46.method578(4, 0, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 6)
		{
			Object obj8;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj8 = class46.method578(4, 0, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 7)
		{
			Object obj9;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj9 = class46.method578(4, 0, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if(k == 8)
		{
			Object obj10;
			if(class46.anInt781 == -1 && class46.childrenIDs == null)
				obj10 = class46.method578(4, 0, l1, i2, j2, k2, -1, -1, -1, -1);
			else
		...
		if (i_261_ > 0 && i_262_ > 0 && i_261_ < 103 && i_262_ < 103)
		  {
			...
			if (i_260_ != 22 || GameConfiguration.GROUND_DECORATION || class46.hasActions
					|| class46.aBoolean736)
			  {
