public final class Animable_Sub3 extends Animable {
	...
	{
		aBoolean1567 = false;
		aSpotAnim_1568 = SpotAnimDefinition.cache[i1];
		anInt1560 = i;
		anInt1561 = l1;
		anInt1562 = k1;
		anInt1563 = j1;
	...
	{
		Model model = aSpotAnim_1568.getModel();//aSpotAnim_1568.aAnimation_407.anInt352
		if(model == null)
			return null;
		...
		if(!aBoolean1567) {
			model_1.createBones();
			if (Client.enableTweening && nextAnimFrameId != -1) {
				model_1.applyAnimation(j, aSpotAnim_1568.aAnimation_407.anIntArray353[nextAnimFrameId],
	...
	private final SpotAnimDefinition aSpotAnim_1568;
