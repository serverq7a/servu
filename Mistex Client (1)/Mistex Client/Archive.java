...
final class Archive {
	...
	public Archive(byte abyte0[])
	{
		...
		int i = buffer.read3Bytes();
		int j = buffer.read3Bytes();
		if(j != i)
		{
		...
		dataSize = buffer.readUnsignedWord();
		anIntArray728 = new int[dataSize];
		anIntArray729 = new int[dataSize];
		anIntArray730 = new int[dataSize];
		anIntArray731 = new int[dataSize];
		int k = buffer.currentOffset + dataSize * 10;
		for(int l = 0; l < dataSize; l++)
		{
			anIntArray728[l] = buffer.readDWord();
			anIntArray729[l] = buffer.read3Bytes();
			anIntArray730[l] = buffer.read3Bytes();
			anIntArray731[l] = k;
			k += anIntArray730[l];
		}
	}
	...
	public byte[] getBytesFromFile(File file) throws IOException {
        ...
        // Close the input buffer and return bytes
        is.close();
        return bytes;
    }
